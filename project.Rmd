...
```{r}
# TODO: check report outline against rubric in
# https://avehtari.github.io/BDA_course_Aalto/project_work/rubric.pdf
```
...
R-squared, ESS, divergences. Interpretation of these values.
